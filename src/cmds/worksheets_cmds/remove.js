exports.command = 'remove <worksheetId>';
...
exports.handler = function (argv) {
  ...
  Client(argv).then((client) => Promise.promisify(client.makeFeedRequest.bind(client))(GOOGLE_FEED_URL + "worksheets/" + argv.spreadsheetId + "/private/full/" + argv.worksheetId, 'DELETE', {}))
